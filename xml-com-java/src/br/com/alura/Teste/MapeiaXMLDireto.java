...
public class MapeiaXMLDireto {
	...
	public static void main(String[] args) throws Exception{
		...
		//adicionar as dependências através do run configurations -> Dependencies -> Modulepath Entries
		...
		//os jars estão no jaxb-jars do diretório principal 
	...
	private static void objetoParaXml(JAXBContext jaxbContext) throws Exception {
		...
		venda.setFormaDePagamento("Crédiário");
		
		List<Produto> produtos = new ArrayList<>();
		produtos.add(new Produto("Livro de Java", 59.90));
		produtos.add(new Produto("Livro de xml", 59.90));
		produtos.add(new Produto("Livro de Orientação a Objetos", 59.90));
